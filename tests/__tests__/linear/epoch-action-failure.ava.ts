...
test('epoch stake failure: deposit_and_stake fails', async (t) => {
...
test('epoch stake failure: get_account fails', async (t) => {
  const { root, contract, owner, alice } = t.context;
  const assertValidator = assertValidatorHelper(t, contract, owner);
...
test('epoch stake failure: balance diff too large', async (t) => {
  const { root, contract, owner, alice } = t.context;
  const assertValidator = assertValidatorHelper(t, contract, owner);
...
test('epoch unstake failure: unstake fails', async (t) => {
  const { root, contract, owner, alice } = t.context;
  const assertValidator = assertValidatorHelper(t, contract, owner);
...
test('epoch unstake failure: get_account fails', async (t) => {
  const { root, contract, owner, alice } = t.context;
  const assertValidator = assertValidatorHelper(t, contract, owner);
...
test('epoch unstake failure: balance diff too large', async (t) => {
  const { root, contract, owner, alice } = t.context;
  const assertValidator = assertValidatorHelper(t, contract, owner);
...
test('get balance failure', async (t) => {
  const { root, contract, owner, alice } = t.context;
  const assertValidator = assertValidatorHelper(t, contract, owner);
